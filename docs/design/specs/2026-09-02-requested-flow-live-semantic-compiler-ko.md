...
- Source Authority: Requested Flow의 기존 의미 검증·공개 schema·호환성 계약은 보존한다. 현재 제품 방향은 `docs/design/specs/2026-09-14-flowview-code-comprehension-ko.md`가 우선한다. 아래 자동 Live 갱신·near-live 목표·storage 전면 개편은 새 FlowView의 필수 범위가 아니다.
