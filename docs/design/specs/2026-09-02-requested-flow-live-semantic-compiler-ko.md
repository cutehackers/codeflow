...
| VS-03 | `REQUESTED-FLOW-LIVE-SEMANTIC-COMPILER-R2-VS-03` | `.tasks/2026-09-02-requested-flow-live-semantic-compiler-ko/vs-03-see-automatic-current-or-gap-ko.md` | `GOAL-05` | 편집 뒤 validated flow를 자동 current로 발행하거나 측정된 gap을 본다. | VS-01, VS-02, VS-04 | FA-03, FA-07–FA-15, FA-19, FA-27, FA-28, FA-32, FA-36–FA-40 | Proposed: 2026-09-09 amendment review required |
