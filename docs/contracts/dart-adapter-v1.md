...
> [!WARNING]
> **Deprecated**: 이 문서는 v0 아카이브 사양입니다. 현재 CodeFlow 런타임 구현은 **NDJSON v1 프로토콜(`ping`, `detect`, `harvest_candidates`, `slice`, `shutdown`)**을 따르며, 공식 표준 계약은 [`docs/design/specs/llm-language-adapter-protocol.md`](../design/specs/llm-language-adapter-protocol.md) 및 [`docs/contracts/adapter-protocol-v1.md`](adapter-protocol-v1.md)를 참조하십시오.
