// Package rflscvs03 contains the executable acceptance runners for the R2
// VS-03 live publication contract.  The runners use the public workspace,
...
var implementationTestIDs = map[string]string{
	"VS03-A1":  "codeflow/internal/rflscvs03.TestRFLSCR2VS03_A01",
	"VS03-A2":  "codeflow/internal/rflscvs03.TestRFLSCR2VS03_A02",
	"VS03-A3":  "codeflow/internal/rflscvs03.TestRFLSCR2VS03_A03",
	"VS03-A4":  "codeflow/internal/rflscvs03.TestRFLSCR2VS03_A04",
	"VS03-A5":  "codeflow/internal/rflscvs03.TestRFLSCR2VS03_A05",
	"VS03-A6":  "codeflow/internal/rflscvs03.TestRFLSCR2VS03_A06",
	"VS03-A7":  "codeflow/internal/rflscvs03.TestRFLSCR2VS03_A07",
	"VS03-A8":  "codeflow/internal/rflscvs03.TestRFLSCR2VS03_A08",
	"VS03-A9":  "codeflow/internal/rflscvs03.TestRFLSCR2VS03_A09",
	"VS03-A10": "codeflow/internal/rflscvs03.TestRFLSCR2VS03_A10",
	"VS03-A11": "codeflow/internal/rflscvs03.TestRFLSCR2VS03_A11",
	"VS03-A12": "codeflow/internal/rflscvs03.TestRFLSCR2VS03_A12",
...
func evidenceFor(criterion, tree string, refs ...string) Evidence {
	...
	all = append(all, refs...)
	return Evidence{Criterion: criterion, ImplementationTestID: implementationTestIDs[criterion], ImplementationPackage: "codeflow/internal/rflscvs03", SnapshotTreeDigest: tree, ObjectRefs: all}
}
...
func canonicalVS02Evidence(t *testing.T, snapshot *workspace.WorkspaceSnapshot, engines ...*workspace.SnapshotEngine) (rflscvs02.AnalyzerRequest, rflscvs02.Result, *semantic.CausalObservationClosure) {
	t.Helper()
	if snapshot == nil {
		t.Fatal("canonical VS-02 evidence requires a captured snapshot")
	}
	var input rflscvs02.SnapshotInput
	var err error
	...
	request, err := rflscvs02.NewAnalyzerRequest("request-vs03-a04", "slice", input, nil, []string{"negative_lookup"})
	if err != nil {
		t.Fatalf("build canonical VS-02 request: %v", err)
	}
	observation := rflscvs02.Observation{Kind: "negative_lookup", Path: "service.go", ValueHash: "negative-vs03-a04", Measured: true}
	...
	for _, document := range input.Documents {
		readDocuments = append(readDocuments, rflscvs02.ReadDocument{
	...
	result := rflscvs02.Result{
		...
		ReadSet: rflscvs02.AnalysisReadSet{
			...
			Documents: readDocuments, NegativeObservations: []rflscvs02.Observation{observation},
		...
		Closure: rflscvs02.ObservationClosure{
			...
			NegativeObservations: []rflscvs02.Observation{observation}, MembershipObservations: []rflscvs02.Observation{}, DependencyFrontiers: []rflscvs02.Observation{},
...
func canonicalProofArtifactsFromResult(result *rflscvs02.Result, projection *semantic.FlowViewProjection) (map[string][]byte, storage.ArtifactRefs, string) {
...
func replaceCanonicalProofArtifacts(tx *storage.PublicationTransaction, request *rflscvs02.AnalyzerRequest, result *rflscvs02.Result, closure *semantic.CausalObservationClosure, mapIR *semantic.SemanticMapIR) {
...
func alignRefinementEvidence(_ *rflscvs02.AnalyzerRequest, result *rflscvs02.Result, closure *semantic.CausalObservationClosure, snapshot *workspace.WorkspaceSnapshot, readSetID, closureID string) {
