// Package catalog contains the executable acceptance runners for the
// evidence-backed onboarding contract. The runners intentionally
...
const (
	implementationPackage = "codeflow/internal/verification/catalog"
