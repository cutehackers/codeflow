...
import (
	...
	"codeflow/internal/collector/verification/impact"
	"codeflow/schemas"
)

const (
	impactImplementationPackage = "codeflow/internal/collector/verification/impact"
	impactExecutionPackage      = "codeflow/internal/collector/contractharness"
)
