...
import (
	...
	"codeflow/internal/collector/verification/compiler"
	"codeflow/schemas"
)

const (
	compilerImplementationPackage = "codeflow/internal/collector/verification/compiler"
	compilerExecutionPackage      = "codeflow/internal/collector/contractharness"
)
...
func expectedVS04ImplementationIDs() map[string]string {
	return map[string]string{
		"VS04-A1": "codeflow/internal/collector/verification/compiler.TestRFLSCR2VS04_A01", "VS04-A2": "codeflow/internal/collector/verification/compiler.TestRFLSCR2VS04_A02",
		"VS04-A3": "codeflow/internal/collector/verification/compiler.TestRFLSCR2VS04_A03", "VS04-A4": "codeflow/internal/collector/verification/compiler.TestRFLSCR2VS04_A04",
		"VS04-A5": "codeflow/internal/collector/verification/compiler.TestRFLSCR2VS04_A05", "VS04-A6": "codeflow/internal/collector/verification/compiler.TestRFLSCR2VS04_A06",
		"VS04-A7": "codeflow/internal/collector/verification/compiler.TestRFLSCR2VS04_A07", "VS04-A8": "codeflow/internal/collector/verification/compiler.TestRFLSCR2VS04_A08",
		"VS04-A9": "codeflow/internal/collector/verification/compiler.TestRFLSCR2VS04_A09", "VS04-A10": "codeflow/internal/collector/verification/compiler.TestRFLSCR2VS04_A10",
		"VS04-A11": "codeflow/internal/collector/verification/compiler.TestRFLSCR2VS04_A11", "VS04-A12": "codeflow/internal/collector/verification/compiler.TestRFLSCR2VS04_A12",
		"VS04-A13": "codeflow/internal/collector/verification/compiler.TestRFLSCR2VS04_A13", "VS04-A14": "codeflow/internal/collector/verification/compiler.TestRFLSCR2VS04_A14",
	}
}
...
func TestVS04EvidenceRegistryRejectsFabricatedPass(t *testing.T) {
	record := compilerEvidence{
		Criterion:             "VS04-A1",
		ImplementationTestID:  "codeflow/internal/collector/verification/compiler.TestRFLSCR2VS04_A01",
