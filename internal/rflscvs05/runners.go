// Package rflscvs05 contains the shared executable acceptance runners for the
// VS-05 impact projection contract. Each runner invokes the semantic impact
...
const (
	implementationPackage = "codeflow/internal/rflscvs05"
