...
var builtinAliasToCanonical = map[string]string{
	...
	"views":          LayerPresentation,
	"widget":         LayerPresentation,
	"widgets":        LayerPresentation,
	"page":           LayerPresentation,
	"pages":          LayerPresentation,
	"screen":         LayerPresentation,
	"screens":        LayerPresentation,
	"dialog":         LayerPresentation,
	"dialogs":        LayerPresentation,
	"component":      LayerPresentation,
	"components":     LayerPresentation,
	"layout":         LayerPresentation,
	"layouts":        LayerPresentation,
	"presentation":   LayerPresentation,
	"controller":     LayerController,
	"controllers":    LayerController,
	"notifier":       LayerController,
	"notifiers":      LayerController,
	"bloc":           LayerController,
	"cubit":          LayerController,
	"viewmodel":      LayerController,
	"viewmodels":     LayerController,
	"store":          LayerController,
	"stores":         LayerController,
	"reducer":        LayerController,
	"reducers":       LayerController,
	"hook":           LayerController,
	"hooks":          LayerController,
	"context":        LayerController,
	"contexts":       LayerController,
	"feature":        LayerController,
	"features":       LayerController,
	"slice":          LayerController,
	"slices":         LayerController,
	"state":          LayerController,
	"provider":       LayerController,
	"providers":      LayerController,
	"application":    LayerUsecase,
	"service":        LayerUsecase,
	"services":       LayerUsecase,
	"interactor":     LayerUsecase,
	"interactors":    LayerUsecase,
	"use_case":       LayerUsecase,
	"usecase":        LayerUsecase,
	"usecases":       LayerUsecase,
	"action":         LayerUsecase,
	"actions":        LayerUsecase,
	"handler":        LayerUsecase,
	"handlers":       LayerUsecase,
	"process":        LayerUsecase,
	"processes":      LayerUsecase,
	"command":        LayerUsecase,
	"commands":       LayerUsecase,
	"query_handler":  LayerUsecase,
	"domain":         LayerDomain,
	"entity":         LayerDomain,
	"entities":       LayerDomain,
	"model":          LayerDomain,
	"models":         LayerDomain,
	"aggregate":      LayerDomain,
	"aggregates":     LayerDomain,
	"vo":             LayerDomain,
	"schema":         LayerDomain,
	"schemas":        LayerDomain,
	"type":           LayerDomain,
	...
	"repositories":   LayerData,
	"datasource":     LayerData,
	"datasources":    LayerData,
	...
	"gateways":       LayerExternal,
	"client":         LayerExternal,
	"clients":        LayerExternal,
