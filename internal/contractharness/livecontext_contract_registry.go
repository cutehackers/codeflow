...
const VS11EvidenceRegistryID = evidence.FlowContextEvidenceRegistryID

var VS11EvidenceCriteria = evidence.FlowContextEvidenceCriteria
...
func ValidateVS11EvidenceRecord(criterion, executionID string, record evidence.FlowContextRecord, expectedPkg, expectedBinary string) error {
