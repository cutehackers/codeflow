...
import (
	...
	"codeflow/internal/verification/analyzer"
...
func buildSnapshotRecord(t *testing.T, shared analyzer.Evidence) snapshotEvidence {
	...
	return snapshotEvidence{
		...
		ImplementationPackage: "codeflow/internal/verification/analyzer", ExecutionPackage: "codeflow/internal/contractharness",
...
func validateSnapshotRecord(criterion, executionID string, record snapshotEvidence) error {
	...
	if record.ImplementationPackage != "codeflow/internal/verification/analyzer" || record.ExecutionPackage != "codeflow/internal/contractharness" || record.ExecutionBinary == "" || record.ExecutionID != executionID {
...
func TestVS02EvidenceRegistryRejectsFabricatedPass(t *testing.T) {
	record := snapshotEvidence{
		Criterion: "VS02-A11", ImplementationTestID: "fabricated", ImplementationPackage: "codeflow/internal/verification/analyzer",
