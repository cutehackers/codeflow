...
import (
	...
	"codeflow/internal/rflscvs04"
	"codeflow/schemas"
)

const (
	vs04ImplementationPackage = "codeflow/internal/rflscvs04"
	vs04ExecutionPackage      = "codeflow/internal/contractharness"
)

type vs04Evidence struct {
...
func TestRFLSCR2VS04_EvidenceRegistry(t *testing.T) {
	...
	runners := map[string]func(*testing.T) rflscvs04.Evidence{
		"VS04-A1": rflscvs04.RunA01, "VS04-A2": rflscvs04.RunA02, "VS04-A3": rflscvs04.RunA03,
		"VS04-A4": rflscvs04.RunA04, "VS04-A5": rflscvs04.RunA05, "VS04-A6": rflscvs04.RunA06,
		"VS04-A7": rflscvs04.RunA07, "VS04-A8": rflscvs04.RunA08, "VS04-A9": rflscvs04.RunA09,
		"VS04-A10": rflscvs04.RunA10, "VS04-A11": rflscvs04.RunA11, "VS04-A12": rflscvs04.RunA12,
		"VS04-A13": rflscvs04.RunA13, "VS04-A14": rflscvs04.RunA14,
	}
...
func expectedVS04ImplementationIDs() map[string]string {
	return map[string]string{
		"VS04-A1": "codeflow/internal/rflscvs04.TestRFLSCR2VS04_A01", "VS04-A2": "codeflow/internal/rflscvs04.TestRFLSCR2VS04_A02",
		"VS04-A3": "codeflow/internal/rflscvs04.TestRFLSCR2VS04_A03", "VS04-A4": "codeflow/internal/rflscvs04.TestRFLSCR2VS04_A04",
		"VS04-A5": "codeflow/internal/rflscvs04.TestRFLSCR2VS04_A05", "VS04-A6": "codeflow/internal/rflscvs04.TestRFLSCR2VS04_A06",
		"VS04-A7": "codeflow/internal/rflscvs04.TestRFLSCR2VS04_A07", "VS04-A8": "codeflow/internal/rflscvs04.TestRFLSCR2VS04_A08",
		"VS04-A9": "codeflow/internal/rflscvs04.TestRFLSCR2VS04_A09", "VS04-A10": "codeflow/internal/rflscvs04.TestRFLSCR2VS04_A10",
		"VS04-A11": "codeflow/internal/rflscvs04.TestRFLSCR2VS04_A11", "VS04-A12": "codeflow/internal/rflscvs04.TestRFLSCR2VS04_A12",
		"VS04-A13": "codeflow/internal/rflscvs04.TestRFLSCR2VS04_A13", "VS04-A14": "codeflow/internal/rflscvs04.TestRFLSCR2VS04_A14",
	}
}

func vs04ExecutionRecord(t *testing.T, shared rflscvs04.Evidence) vs04Evidence {
	t.Helper()
	return vs04Evidence{
		...
		ExecutionPackage:      vs04ExecutionPackage,
...
func validateVS04EvidenceRecord(criterion, executionID string, record vs04Evidence, expectedImplementation map[string]string) error {
	if record.Criterion != criterion {
		return fmt.Errorf("criterion identity mismatch: got %q want %q", record.Criterion, criterion)
	}
	if record.ImplementationTestID != expectedImplementation[criterion] || record.ImplementationPackage != vs04ImplementationPackage {
		return fmt.Errorf("implementation identity mismatch: %+v", record)
	}
	if record.ExecutionPackage != vs04ExecutionPackage || record.ExecutionBinary == "" || record.ExecutionID != executionID {
...
func TestVS04EvidenceRegistryRejectsFabricatedPass(t *testing.T) {
	record := vs04Evidence{
		Criterion:             "VS04-A1",
		ImplementationTestID:  "codeflow/internal/rflscvs04.TestRFLSCR2VS04_A01",
		ImplementationPackage: vs04ImplementationPackage,
		ExecutionPackage:      vs04ExecutionPackage,
