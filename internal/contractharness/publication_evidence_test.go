...
import (
	...
	"codeflow/internal/verification/publication"
	"codeflow/schemas"
)

const (
	publicationImplementationPackage = "codeflow/internal/verification/publication"
	publicationExecutionPackage      = "codeflow/internal/contractharness"
)
...
type publicationEvidence struct {
	...
	Trace                 *publication.TraceEvidence      `json:"trace,omitempty"`
	ViewCorpus            *publication.ViewCorpusEvidence `json:"viewCorpus,omitempty"`
}
...
func TestRFLSCR2VS03_EvidenceRegistry(t *testing.T) {
	...
	runners := map[string]func(*testing.T) publication.Evidence{
		"VS03-A1": publication.RunA01, "VS03-A2": publication.RunA02, "VS03-A3": publication.RunA03,
		"VS03-A4": publication.RunA04, "VS03-A5": publication.RunA05, "VS03-A6": publication.RunA06,
		"VS03-A7": publication.RunA07, "VS03-A8": publication.RunA08, "VS03-A9": publication.RunA09,
		"VS03-A10": publication.RunA10, "VS03-A11": publication.RunA11, "VS03-A12": publication.RunA12,
		"VS03-A13": publication.RunA13, "VS03-A14": publication.RunA14, "VS03-A15": publication.RunA15,
		"VS03-A16": publication.RunA16, "VS03-A17": publication.RunA17, "VS03-A18": publication.RunA18,
		"VS03-A19": publication.RunA19, "VS03-A20": publication.RunA20,
	}
...
func expectedVS03ImplementationIDs() map[string]string {
	return map[string]string{
		"VS03-A1": "codeflow/internal/verification/publication.TestRFLSCR2VS03_A01", "VS03-A2": "codeflow/internal/verification/publication.TestRFLSCR2VS03_A02",
		"VS03-A3": "codeflow/internal/verification/publication.TestRFLSCR2VS03_A03", "VS03-A4": "codeflow/internal/verification/publication.TestRFLSCR2VS03_A04",
		"VS03-A5": "codeflow/internal/verification/publication.TestRFLSCR2VS03_A05", "VS03-A6": "codeflow/internal/verification/publication.TestRFLSCR2VS03_A06",
		"VS03-A7": "codeflow/internal/verification/publication.TestRFLSCR2VS03_A07", "VS03-A8": "codeflow/internal/verification/publication.TestRFLSCR2VS03_A08",
		"VS03-A9": "codeflow/internal/verification/publication.TestRFLSCR2VS03_A09", "VS03-A10": "codeflow/internal/verification/publication.TestRFLSCR2VS03_A10",
		"VS03-A11": "codeflow/internal/verification/publication.TestRFLSCR2VS03_A11", "VS03-A12": "codeflow/internal/verification/publication.TestRFLSCR2VS03_A12",
		"VS03-A13": "codeflow/internal/verification/publication.TestRFLSCR2VS03_A13", "VS03-A14": "codeflow/internal/verification/publication.TestRFLSCR2VS03_A14",
		"VS03-A15": "codeflow/internal/verification/publication.TestRFLSCR2VS03_A15",
		"VS03-A16": "codeflow/internal/verification/publication.TestRFLSCR2VS03_A16", "VS03-A17": "codeflow/internal/verification/publication.TestRFLSCR2VS03_A17",
		"VS03-A18": "codeflow/internal/verification/publication.TestRFLSCR2VS03_A18", "VS03-A19": "codeflow/internal/verification/publication.TestRFLSCR2VS03_A19",
		"VS03-A20": "codeflow/internal/verification/publication.TestRFLSCR2VS03_A20",
	}
}

func buildPublicationRecord(t *testing.T, shared publication.Evidence) publicationEvidence {
	t.Helper()
	return publicationEvidence{
		...
		ExecutionPackage: publicationExecutionPackage, ExecutionBinary: filepath.Base(os.Args[0]), ExecutionID: t.Name(),
...
func validateVS03EvidenceRecord(criterion, executionID string, record publicationEvidence, expected map[string]string) error {
	if record.Criterion != criterion || record.ImplementationTestID != expected[criterion] || record.ImplementationPackage != publicationImplementationPackage {
		return fmt.Errorf("implementation identity mismatch: %+v", record)
	}
	if record.ExecutionPackage != publicationExecutionPackage || record.ExecutionBinary == "" || record.ExecutionID != executionID {
...
func validateVS03Trace(trace *publication.TraceEvidence) error {
...
func validateVS03Corpus(corpus *publication.ViewCorpusEvidence) error {
...
func TestVS03EvidenceRegistryRejectsFabricatedPass(t *testing.T) {
	record := publicationEvidence{
		Criterion: "VS03-A1", ImplementationTestID: "codeflow/internal/verification/publication.TestRFLSCR2VS03_A01", ImplementationPackage: publicationImplementationPackage,
		ExecutionPackage: publicationExecutionPackage, ExecutionBinary: "contractharness.test", ExecutionID: "fake-execution", Result: "pass",
