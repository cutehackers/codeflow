...
func TestEmbeddedTaskViewWorkspaceIdentityBindsApprovalReceiptAndHistory(t *testing.T) {
	...
	script := strings.Join(append(parts,
		...
		"function renderAll(){};function renderRequirementAlignment(){};function setViewStateStatus(){};function hideVerifiedGap(){};function showVerifiedGap(){};function syncApprovalControls(){};function loadApprovalHistory(){};function hideTaskError(){};function loadAnalyses(){};",
